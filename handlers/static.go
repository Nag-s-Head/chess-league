...
func PrivacyPolicy(WithLayout LayoutFn) func(w http.ResponseWriter, r *http.Request) {
...
func Rules(WithLayout LayoutFn) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
